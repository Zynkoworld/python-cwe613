...
## Proven
Measured on a **discriminating** probe corpus of **22 cases (10 flagged + 12 safe)** — verified by
...
These numbers hold **on the published probe set (N=22)**. A probe set is a floor, not a
